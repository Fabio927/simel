...
public class Email {
    ...
    private void init(){
        try {
            ...
            propiedades.setProperty("mail.smtp.ssl.trust", "smtp.gmail.com"); //Nueva línea para enviar correo
            ...
            mimeMessage.setRecipients(Message.RecipientType.TO,  InternetAddress.parse(emailDestinatario));
            // mimeMessage.setRecipient(Message.RecipientType.TO,  new InternetAddress(emailDestinatario)); PARA ENVIAR A UNA SOLA PERSONA
    ...
    public boolean enviarSimple(String asunto, String contenido){
        try {
            ...
            //texto.setText(contenido); PARA ENVIAR TEXTO SIMPLE EN EL CORREO
            texto.setContent(contenido,"text/html"); //PARA ENVIAR TEXTO CON FORMATO HTML
